...
//		driver.phase2();
	...
	private void runWithPermutations(int actorCount, int potMultiplier, float flatReward, boolean divyPotByPercent, float punishment, float minEntry, float learningRate) {
		float bigSpender = 1f;
		...
		for(List<Float> list : permutationList) {
			GameController gc = new GameController(3, potMultiplier, divyPotByPercent, flatReward, punishment, minEntry, learningRate);
			for(Float type : list) {
...
//		runWithPermutations(5, 2, 0, false, 0f, 0f);
//		System.out.println("Variable multiplier ..................................");
//		runWithPermutations(3, 3, 0, false, 0f, 0f);
//		System.out.println("Flat reward added to the one given most resources.....");
//		runWithPermutations(3, 2, 100, false, 0f, 0f);
//		System.out.println("More personalities introduced.........................");
//		GameController gc = new GameController(1, 2, false, 0, 0, 0);
